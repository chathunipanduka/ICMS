...
try {
    ...
    String sql = "SELECT id_notification_tb, complaint_id, message, is_read, create_at "
               ...
               + "WHERE dept_id = (SELECT id_dept_tb FROM dept_tb WHERE deptName = ?) and type='new_complaint' "
...
<tr class="<%=rowClass%>">
    ...
    <td><%=dateTime%></td>
    <td>
        <form action="${pageContext.request.contextPath}/ViewAdmNotificationServlet" method="post" style="margin:0;">
