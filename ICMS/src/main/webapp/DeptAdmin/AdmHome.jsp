  ...
  <div class="row g-4 justify-content-center">
    ...
    <div class="col-md-3">
      <div class="card text-center p-4">
        ...
        <a href="AdmComplaints.jsp" class="btn btn-success mt-3 w-75">View</a>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card text-center p-4">
        ...
        <a href="dmComplaints.jsp" class="btn btn-warning mt-3 w-75 text-white">View</a>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card text-center p-4">
        ...
        <a href="dmComplaints.jsp" class="btn btn-primary mt-3 w-75">View</a>
      </div>
    </div>
