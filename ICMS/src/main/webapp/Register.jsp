...
.navbar-toggler-icon {
	background-image:
		url("data:image/svg+xml;charset=utf8,%3Csvg viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath stroke='white' stroke-width='2' stroke-linecap='round' stroke-miterlimit='10' d='M4 7h22M4 15h22M4 23h22'/%3E%3C/svg%3E");
}
...
<body>
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container-fluid">
			<a class="navbar-brand fw-bold" href="Home.jsp"> <img
				src="media/BPS_LOGO.png" alt="Logo" width="45" class="me-2"> <span
				id="title">Infrastructure Complaint Management System</span>
			</a>
		...
		<form action="RegisterServlet" method="post">
			...
			<div class="mb-3">
				<label class="form-label">Contact No</label> <input type="text"
					class="form-control" name="contact" placeholder="Enter contact No"
					required>
			</div>
			<div class="mb-3">
			...
			<div class="text-center">
				<small>Already have an account? <a href="Login.jsp"
					class="fw-bold">Login here</a></small>
			</div>
		</form>
	</div>
			...
			<div class="row text-center text-md-start">
				...
				<div class="col-md-4 mb-3">
					...
					<ul class="list-unstyled">
						...
						<li><a href="Login.jsp"
							class="text-light text-decoration-none">Submit Complaint</a></li>
						<li><a href="About.jsp"
